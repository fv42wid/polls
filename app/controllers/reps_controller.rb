class RepsController < ApplicationController
  ...
  private
    ...
    def rep_params
      params.require(:rep).permit(:nyt_id, :first_name, :last_name, :rep_url, :role, :gender, :party, :twitter_id, :youtube_id, :seniority, :next_election, :govtrack_id, :state, :district, :start_date)
    end
end
